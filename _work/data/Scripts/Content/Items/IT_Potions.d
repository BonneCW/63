...
/*	TEXT[1]			= 	NAME_Bonus_Mana;				
	...
	FUNC VOID UseItPo_Mana()
	{
		...
		Npc_ChangeAttribute	(self,	ATR_MANA, (hero.attribute[ATR_MANA_MAX]/2));
	};

INSTANCE ItPo_HP(C_Item)
{
	name 			=	NAME_Trank;
	...
	on_state[0]		=	UseItPo_HP;
	scemeName		=	"POTIONFAST";

	wear			= 	WEAR_EFFECT;
	effect			=	"SPELLFX_MANAPOTION";

	description		= 	"Lebenstrank";
	...
	FUNC VOID UseItPo_HP()
	{
		
		Npc_ChangeAttribute	(self,	ATR_HITPOINTS, (hero.attribute[ATR_HITPOINTS_MAX]/2));
	};
