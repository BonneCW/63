...
CONST STRING TXT_TALENTS [NPC_TALENT_MAX] =
{
	...
	"Lebensreg.",							//raus //NPC_TALENT_REGENERATE	= 9;
	"Manareg.",							//raus //NPC_TALENT_FIREMASTER	= 10;
	"Akrobatik",				//NPC_TALENT_ACROBAT			= 11;
	"Orktöter",			//NPC_TALENT_PICKPOCKET			= 12;	//NEUES	Pickpocket
	"Parasit",				//NPC_TALENT_SMITH				= 13;
	"Slowmotion",			//NPC_TALENT_RUNES				= 14;
...
CONST STRING TXT_TALENTS_SKILLS	[NPC_TALENT_MAX] =
{
	...
	"-|Gelernt",														//raus //NPC_TALENT_REGENERATE	= 9;
	"-|Gelernt",														//raus //NPC_TALENT_FIREMASTER	= 10;
