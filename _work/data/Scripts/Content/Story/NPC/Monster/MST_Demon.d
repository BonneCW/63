...
PROTOTYPE Mst_Default_Demon(C_Npc)			
{
	...
	attribute	[ATR_HITPOINTS_MAX]	=	1470;
	attribute	[ATR_HITPOINTS]		=	1470;
	attribute	[ATR_MANA_MAX] 		=	200;
	attribute	[ATR_MANA] 			=	200;
	
	//----- Protections ----
	protection	[PROT_BLUNT]		=	755;
	protection	[PROT_EDGE]			=	755;
	protection	[PROT_POINT]		=	755;
	protection	[PROT_FIRE]			=	755;
	protection	[PROT_FLY]			=	755;
	protection	[PROT_MAGIC]		=	755;
...
INSTANCE Demon_02 (Mst_Default_Demon)
{
	B_SetVisuals_Demon();
	Npc_SetToFistMode(self);
...
INSTANCE Demon_03 (Mst_Default_Demon)
{
	B_SetVisuals_Demon();
	Npc_SetToFistMode(self);
...
INSTANCE Demon_04 (Mst_Default_Demon)
{
	B_SetVisuals_Demon();
	Npc_SetToFistMode(self);
...
INSTANCE Demon_05 (Mst_Default_Demon)
{
	B_SetVisuals_Demon();
	Npc_SetToFistMode(self);
...
INSTANCE Demon_06 (Mst_Default_Demon)
{
	B_SetVisuals_Demon();
	Npc_SetToFistMode(self);
...
INSTANCE Demon_07 (Mst_Default_Demon)
{
	B_SetVisuals_Demon();
	Npc_SetToFistMode(self);
...
INSTANCE Demon_08 (Mst_Default_Demon)
{
	B_SetVisuals_Demon();
	Npc_SetToFistMode(self);
...
INSTANCE Demon_09 (Mst_Default_Demon)
{
	B_SetVisuals_Demon();
	Npc_SetToFistMode(self);
...
INSTANCE Demon_10 (Mst_Default_Demon)
{
	B_SetVisuals_Demon();
	Npc_SetToFistMode(self);
