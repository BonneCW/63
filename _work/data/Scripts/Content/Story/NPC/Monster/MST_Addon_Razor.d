...
//--------------------------------------------------------------
	...
	attribute	[ATR_HITPOINTS_MAX]	= 570;
	attribute	[ATR_HITPOINTS]		= 570;
	attribute	[ATR_MANA_MAX] 		= 0;
	attribute	[ATR_MANA] 			= 0;
//--------------------------------------------------------------
	protection	[PROT_BLUNT]		= 305;
	protection	[PROT_EDGE]			= 305;
	protection	[PROT_POINT]		= 305;
	protection	[PROT_FIRE]			= 305;
	protection	[PROT_FLY]			= 305;
...
INSTANCE Razor_01 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
...
INSTANCE Razor_02 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
...
INSTANCE Razor_03 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
...
INSTANCE Razor_04 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
...
INSTANCE Razor_05 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
...
INSTANCE Razor_06 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
...
INSTANCE Razor_07 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
...
INSTANCE Razor_08 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
...
INSTANCE Razor_09 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
...
INSTANCE Razor_10 (Mst_Default_Razor)
{
	Set_Razor_Visuals();
	Npc_SetToFistMode(self);
