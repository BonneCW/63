...
PROTOTYPE Mst_Default_OrcWarrior(C_Npc)			
{
	...
	//----- Attribute -----	
	attribute	[ATR_STRENGTH]		=	270; //+ca. 50-80 Waffe //MIN 100 wg Equip!!!
	attribute	[ATR_DEXTERITY]		=	270;
	attribute	[ATR_HITPOINTS_MAX]	=	510;
	attribute	[ATR_HITPOINTS]		=	510;
	attribute	[ATR_MANA_MAX] 		=	0;
	attribute	[ATR_MANA] 			=	0;
	
	//----- Protections ----	
	protection	[PROT_BLUNT]		=	275;
	protection	[PROT_EDGE]			=	275;
...
INSTANCE OrcWarrior_01 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
...
INSTANCE OrcWarrior_02 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
...
INSTANCE OrcWarrior_03 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
...
INSTANCE OrcWarrior_04 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
...
INSTANCE OrcWarrior_05 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
...
INSTANCE OrcWarrior_06 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
...
INSTANCE OrcWarrior_07 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
...
INSTANCE OrcWarrior_08 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
...
INSTANCE OrcWarrior_09 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
...
INSTANCE OrcWarrior_10 (Mst_Default_OrcWarrior)
{
	//-------- visual --------
	B_SetVisuals_OrcWarrior();
