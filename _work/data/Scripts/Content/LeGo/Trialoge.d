 ...
 *
 * Info:
 *  Erlaubt beliebig viele Npcs an einem Dialog teilnehmen zu lassen. Außerdem werden
 *  Kamerafahrten während des Gesprächs erlaubt.
 *
 * Inhalt:
 ...
 *     Hilfsfunktionen, der Name ist hier Programm
 *
 *  void DiaCAM_Update()
 ...
 *     Lädt einen Npc in ein Gespräch ein
 *     slf   : Der eingeladene Npc
 *
 *  void TRIA_Start()
 *     Startet einen Trialog. Davor sollten alle Partner über Invite eingeladen werden
 *
 *  void TRIA_Barrier()
 *     Ähnlich wie TRIA_Wait, betrifft aber alle teilnehmenden Npcs
 *
 ...
 *     evt   : Name der Kamerafahrt im Spacer. Wird für evt "" übergeben wird die laufende Kamerafahrt abgebrochen
 *
 *  void TRIA_Finish()
 *     Schließt einen laufenden Trialog ab. MUSS immer am Ende aufgerufen werden, sonst können keine weiteren Trialoge gestartet werden
 *
 * Um die Trialoge verwenden zu können muss LeGo_Init mit dem Flag LeGo_Trialoge aufgerufen werden
 */
