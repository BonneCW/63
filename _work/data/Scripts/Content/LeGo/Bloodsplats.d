 ...
 *      damage  : Der Schaden (beeinflusst die Größe des Flecks)
 *
 *  void Bloodsplats_Rage()
 *      Ziemlich sinnlose Funktion die den gesamten Bildschirm vollschmiert.
 *
 * Um die Bloodsplats verwenden zu können müssen die beigelegten Texturen vorhanden sein. Außerdem sollte der Vfx "HERO_HURT" (ebenfalls beigelegt) in der VfxInst.d eingetragen sein um einen noch besseren Treffer-Effekt zu erzeugen.
 *
 * Um die Bloodsplats automatisch bei Schaden den der Held erhält zu aktivieren muss LeGo_Init mit dem Flag LeGo_Bloodsplats aufgerufen werden.
