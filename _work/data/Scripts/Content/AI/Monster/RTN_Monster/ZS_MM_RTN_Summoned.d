	...
	else //<= 500
	{
		if (Npc_GetStateTime(self) >= 1)
		{
			...
			if (Mod_Circle	<	6)
			{
				...
				if (Mod_Circle	==	1)
				{
					if (self.aivar[AIV_SummonTime] >= MONSTER_SUMMON_TIME_CIRCLE_1)
					{
						 Npc_ChangeAttribute (self, ATR_HITPOINTS, -self.attribute[ATR_HITPOINTS_MAX]);
					};
				}
				...
				{
					if (self.aivar[AIV_SummonTime] >= MONSTER_SUMMON_TIME_CIRCLE_2)
					{
						 Npc_ChangeAttribute (self, ATR_HITPOINTS, -self.attribute[ATR_HITPOINTS_MAX]);
					};
				}
				...
				{
					if (self.aivar[AIV_SummonTime] >= MONSTER_SUMMON_TIME_CIRCLE_3)
					{
						 Npc_ChangeAttribute (self, ATR_HITPOINTS, -self.attribute[ATR_HITPOINTS_MAX]);
					};
				}
				...
				{
					if (self.aivar[AIV_SummonTime] >= MONSTER_SUMMON_TIME_CIRCLE_4)
					{
						 Npc_ChangeAttribute (self, ATR_HITPOINTS, -self.attribute[ATR_HITPOINTS_MAX]);
					};
				}
				...
				{
					if (self.aivar[AIV_SummonTime] >= MONSTER_SUMMON_TIME_CIRCLE_5)
					{
						 Npc_ChangeAttribute (self, ATR_HITPOINTS, -self.attribute[ATR_HITPOINTS_MAX]);
					};
				};
