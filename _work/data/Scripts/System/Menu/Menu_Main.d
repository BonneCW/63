...
INSTANCE MENU_MAIN(C_MENU_DEF) 
{
	...
	items[10]		= "MENUITEM_MAIN_HEADING";
...
instance MENUITEM_MAIN_NEWGAME(C_MENU_ITEM_DEF) 
{
	...
	text[0]		= "Schlacht beginnen";
	text[1]		= "Eine neue Schlacht beginnen.";  // Kommentar
...
INSTANCE MENUITEM_MAIN_EXIT(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Beenden";
	text[1]		= "Das Spiel beenden";  // Kommentar
...
INSTANCE MENUITEM_MAIN_HEADING(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		=	"63";
	type		=	MENU_ITEM_TEXT;
	fontName	=	"Menu_Font.tga";
	// Position und Dimension
	posx		=	250;		posy		=	1500;
	dimx		=	8192;
