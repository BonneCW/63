...
{
	text[0]		= "Wirklich eine neue Schlacht beginnen?";   		
	type		= MENU_ITEM_TEXT;
	// Position und Dimension	
	posx		=    0;		posy		= 3400;
	dimx		= 8100;		dimy		=  750;
...
INSTANCE MENUITEM_REALLY_NEWGAME_YES(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ja";
	text[1]		= "Ja, ich will eine neue Schlacht starten."; // Kommentar
...
INSTANCE MENUITEM_REALLY_NEWGAME_NO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Nein";
	text[1]		= "Nein, ich möchte keine neue Schlacht starten."; // Kommentar
